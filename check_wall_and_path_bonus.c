...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/04 20:16:02 by osouadi           #+#    #+#             */
/*   Updated: 2025/01/04 20:16:04 by osouadi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_valid_path(t_data *data, int nmbc)
{
	...
	data->map->cpy = malloc((data->map->height + 1) * sizeof(char *));
	if (data->map->cpy == NULL)
		return (0);
	i = 0;
	while (i < height)
	{
